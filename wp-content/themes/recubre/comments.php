...
<?php if ( have_comments() ) : ?>
	<?php if( absint($single_post_config['show_comment_list']) == 1 ) : ?>	
		<?php if( absint($single_post_config['show_comment_list_phone']) != 1 ) echo "<div class='hidden-phone'>";?>
			<h3 class="heading-title" id="comments-title"><?php
			global $post;
			?>
			<?php
				echo stripslashes(esc_attr($single_post_config['comment_list_label']));
			...
			<?php endif; // check for comment navigation ?>
			<?php if( $single_post_config['show_comment_list_phone'] != 1 ) echo "</div>";?>
	<?php endif; ?>
