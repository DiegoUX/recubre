...
<div class="social_sharing">
	<div class="social-des">
		<h6 class="title-social"><?php echo $_sharing_title = sprintf( __( '%s','wpdance' ), stripslashes(esc_attr($single_prod_datas['sharing_title'])) ) ;?></h6>
	...
	<div class="social_icon">	
		...
		<?php echo stripslashes(htmlspecialchars_decode($single_prod_datas["sharing_custom_code"]));?>
