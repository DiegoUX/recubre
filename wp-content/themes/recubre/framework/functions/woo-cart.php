			...
			<div class="wd_tini_cart_control ">
				...
				<span class="cart_size">
					<a href="<?php echo $woocommerce->cart->get_cart_url();?>" title="<?php _e('View your shopping bag','wpdance');?>">
						<span><?php _e('shopping bag','wpdance');?> </span>
					</a>
					: <span class="cart_subtotal"><?php echo $woocommerce->cart->get_cart_subtotal(); ?></span>
					<span class="cart_division">/</span>
					<span id="cart_size_value_head"><?php echo $woocommerce->cart->cart_contents_count;?></span> <?php _e('item','wpdance')?>(S)</span>
				
			</div>
			<div class="cart_dropdown drop_down_container">
				<div class="dropdown_header">
					<h4><a href="<?php echo $woocommerce->cart->get_cart_url();?>"><?php _e('shopping bag','wpdance');?></a></h4>
						<span class="cart_dropdown_size <?php if( $_cart_empty ) echo "size_empty";?>">
							<label>	
								<?php if ( !$_cart_empty ) : ?>
									<?php _e('there are','wpdance');?> 
									<span id="cart_size_value"><?php echo $woocommerce->cart->cart_contents_count;?></span>
				...
				<div class="dropdown_body">
					<span class="head_msg"><?php _e('recently added item(s)','wpdance');?></span>
