					...
					<div class="area-inner1">
						...
						<div class="area-content">
							<ul class="payment-list">
								...
								<li class="payment_image">	
								
									<?php 
										$visa_image_src = get_option(THEME_SLUG.'visa_image','');
										if( strlen(trim($visa_image_src)) <= 0 ){
											$visa_image_src = get_template_directory_uri().'/images/no-image.png';
											$value_visa_image_src = '';
										}else{
											$visa_image_src = esc_url($visa_image_src);
											$value_visa_image_src = $visa_image_src;
										}
									?>
									<span class="label"><?php _e('Visa image','wpdance')?></span>
									<div>
										<input name="wd_custom_visa" type="hidden" class="custom_upload_image" value="<?php echo $value_visa_image_src; ?>" />
										<img  src="<?php echo $visa_image_src; ?>" class="custom_preview_image" /><br />
										<input class="custom_upload_image_button button" type="button" value="Choose Image" />
										<small>&nbsp;<a href="#" class="custom_clear_image_button">Remove Image</a></small>
										<br clear="all" />
									</div>									
								...
								<li class="payment_image">	
									...
									<?php 
										$mastercard_image_src = get_option(THEME_SLUG.'mastercard_image','');
										if( strlen(trim($mastercard_image_src)) <= 0 ){
											$visa_image_src = get_template_directory_uri().'/images/no-image.png';
											$value_mastercard_image_src = '';
										}else{
											$mastercard_image_src = esc_url($mastercard_image_src);
											$value_mastercard_image_src = $mastercard_image_src;
										}
									?>
									<span class="label"><?php _e('MasterCard image','wpdance')?></span>
									<div>
										<input name="wd_custom_mastercard" type="hidden" class="custom_upload_image" value="<?php echo $value_mastercard_image_src; ?>" />
										<img src="<?php echo $mastercard_image_src; ?>" class="custom_preview_image" /><br />
										<input class="custom_upload_image_button button" type="button" value="Choose Image" />
										<small>&nbsp;<a href="#" class="custom_clear_image_button">Remove Image</a></small>
										<br clear="all" />
									</div>									
								...
								<li class="payment_image">	
									...
									<?php 
										$americanexpress_image_src = get_option(THEME_SLUG.'americanexpress_image','');
										if( strlen(trim($americanexpress_image_src)) <= 0 ){
											$americanexpress_image_src = get_template_directory_uri().'/images/no-image.png';
											$value_americanexpress_image_src = '';
										}else{
											$americanexpress_image_src = esc_url($americanexpress_image_src);
											$value_americanexpress_image_src = $americanexpress_image_src;
										}
									?>
									<span class="label"><?php _e('AmericanExpress image','wpdance')?></span>
									<div>
										<input name="wd_custom_americanexpress" type="hidden" class="custom_upload_image" value="<?php echo $value_americanexpress_image_src; ?>" />
										<img src="<?php echo $americanexpress_image_src; ?>" class="custom_preview_image" /><br />
										<input class="custom_upload_image_button button" type="button" value="Choose Image" />
										<small>&nbsp;<a href="#" class="custom_clear_image_button">Remove Image</a></small>
										<br clear="all" />
									</div>									
								...
								<li class="payment_image">	
									...
									<?php 
										$paypal_image_src = get_option(THEME_SLUG.'paypal_image','');
										if( strlen(trim($paypal_image_src)) <= 0 ){
											$paypal_image_src = get_template_directory_uri().'/images/no-image.png';
											$value_paypal_image_src = '';
										}else{
											$paypal_image_src = esc_url($paypal_image_src);
											$value_paypal_image_src = $paypal_image_src;
										}
									?>
									<span class="label"><?php _e('Paypal image','wpdance')?></span>
									<div>
										<input name="wd_custom_paypal" type="hidden" class="custom_upload_image" value="<?php echo $value_paypal_image_src; ?>" />
										<img src="<?php echo $paypal_image_src; ?>" class="custom_preview_image" /><br />
										<input class="custom_upload_image_button button" type="button" value="Choose Image" />
										<small>&nbsp;<a href="#" class="custom_clear_image_button">Remove Image</a></small>
										<br clear="all" />
									</div>									
