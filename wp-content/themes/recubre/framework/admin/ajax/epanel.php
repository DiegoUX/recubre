...
class AjaxEpanel extends AdminTheme
{
	...
	public function saveGeneralConfig(){
		...
		if( $_POST['wd_custom_visa'] ){
			update_option(THEME_SLUG.'visa_image',wp_kses_data($_POST['wd_custom_visa']));
		}
		update_option(THEME_SLUG.'mastercard_link', $_POST['mastercard_link']);
		if( $_POST['wd_custom_mastercard'] ){
			update_option(THEME_SLUG.'mastercard_image',wp_kses_data($_POST['wd_custom_mastercard']));
		}
		update_option(THEME_SLUG.'americanexpress_link', $_POST['americanexpress_link']);
		if( $_POST['wd_custom_americanexpress'] ){
			update_option(THEME_SLUG.'americanexpress_image',wp_kses_data($_POST['wd_custom_americanexpress']));
		}
		update_option(THEME_SLUG.'paypal_link', $_POST['paypal_link']);
		if( $_POST['wd_custom_paypal'] ){
			update_option(THEME_SLUG.'paypal_image',wp_kses_data($_POST['wd_custom_paypal']));
		}
